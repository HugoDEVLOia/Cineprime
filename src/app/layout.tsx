...
import { Film, Clapperboard, Search, Tv, BarChart3, Menu, SettingsIcon, X, Gamepad2, Compass, User as UserIcon, CalendarDays } from 'lucide-react';
...
import { UserProvider, useUser } from '@/contexts/user-provider';
...
function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-lg" style={{ height: 'var(--header-height)' }}>
                      ...
                      <nav className="flex flex-col space-y-1">
                        ...
                        <SheetClose asChild>
                         ...
                         <SheetClose asChild>
                          <Link href="/calendar">
                            <Button variant="ghost" className="w-full justify-start gap-3 px-3 py-2.5 text-base">
                              <CalendarDays className="h-5 w-5 text-muted-foreground" /> Calendrier
                            </Button>
                          </Link>
                        </SheetClose>
                         <SheetClose asChild>
